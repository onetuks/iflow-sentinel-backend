...
public class IntegrationPackageService {
    ...
    public IntegrationPackageService(TenantRepository tenantRepository, IntegrationPackageRepository packageRepository, PackageSyncService packageSyncService) {
